...
#define ALPHABLEND_PROJECTION_TEXT N_("Enable alpha blend projection")
#define ALPHABLEND_PROJECTION_LONGTEXT N_("Enable alpha blend projection")
...
vlc_module_begin()
    ...
    set_shortname("OpenGL_for_alpha_blend")
    set_description(N_("OpenGL video output for Windows with alpha blending"))
    ...
    add_shortcut("glwin32_alphablend", "opengl_alphablend")
