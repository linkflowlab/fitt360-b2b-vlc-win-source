...
void FrameRender(stobj* dat)
{
    if(dat->isParamAvailable[FRONT]) {
        ...
        dat->RTSPframe(Rect(0, 0, dat->RTSPframe.cols, dat->RTSPframe.rows/2)).copyTo(dat->RTSPframe_result(Rect(0, 0, dat->RTSPframe.cols, dat->RTSPframe.rows/2)));
    }
    ...
    if(dat->isParamAvailable[REAR]) {
        ...
        dat->RTSPframe(Rect(0, dat->OutHeight/2, dat->RTSPframe.cols, dat->RTSPframe.rows/2)).copyTo(dat->RTSPframe_result(Rect(0, dat->OutHeight/2, dat->RTSPframe.cols, dat->RTSPframe.rows/2)));
    }
